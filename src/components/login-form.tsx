            ...
            <FieldGroup>
              ...
              <Field>
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className="ml-auto text-sm underline-offset-2 hover:underline font"
                  >
                    Esqueceu sua senha?
                  </a>
                </div>
              ...
              <Field className="grid grid-cols-3 gap-4">
                <Button
                  type="button"
                  className="bg-white text-blue-dark hover:bg-blue-dark hover:text-white rounded-md border-2 border-blue-dark  flex items-center justify-center gap-2 p-2"
                >
                  <svg
